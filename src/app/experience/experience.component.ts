  ...
  ngOnInit() {
    this._content = [
      new Job(
        ...
        '../../assets/accenturelogo.png' ),
      new Job( 'Epic Systems',
      ...
      new Job( 'Bucknell University',
        ...
        '../../assets/bucknelllogo.png'),
      new Job( 'Americorps',
        'Trail Crew',
        ['Rebuilding trails fallen into disrepair using exclusively hand tools in a remote wilderness area as part of a tightly knit trail crew'],
        '../../assets/americorpslogo.png')
    ];
  }
